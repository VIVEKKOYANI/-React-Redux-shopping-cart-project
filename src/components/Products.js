...
function Products({id, name, description, img, price, addFunc}) {
    return (
        <article className="mw5 center bg-white br3 pa3 pa4-ns mv3 ba b--black-10" id={id}>
            <div className="tc">
                ...
                <button onClick={() => addFunc({id, name, description, img, price, units: 1})} className="f6 link dim br3 ph3 pv2 mb2 dib white bg-dark-green ba">Add</button>
                <span>$ {price}</span>
            </div>
        </article>
    )
